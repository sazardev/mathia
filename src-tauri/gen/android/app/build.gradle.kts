...
android {
    ...
    signingConfigs {
        create("release") {
            // Firma configurable vía variables de entorno (usado en CI).
            // Ver https://tauri.app/distribute/sign/android/
            ...
            if (keystorePath != null) {
                ...
                keyAlias = System.getenv("TAURI_ANDROID_KEY_ALIAS") ?: "mathia"
