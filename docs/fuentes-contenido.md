...
| **IM 9–12 Math — Algebra 1/Geometry/Algebra 2, First Edition (2019)** (`im.kendallhunt.com/HS/`, antes `curriculum.illustrativemathematics.org/HS/`, que ahora redirige ahí) | **CC BY 4.0** (footer enlaza directo a `creativecommons.org/licenses/by/4.0`, sin lenguaje de "commercial"/"non-commercial" en la página — verificado 2026-09-15) | Cubre justo el hueco de Álgebra 2 que ni BCcampus ni OUR 6-8 alcanzan (polinomios, exponenciales/log, cuadráticas avanzadas). **Bonus: Álgebra 1 ya existe oficialmente en español** (`/AGA_ES/students/1/`). OJO: es una edición DISTINTA de "IM v.360" (edición actual que Kendall Hunt promueve activamente) — v.360 es CC BY-NC 4.0 y además tiene una restricción contractual de uso comercial en sus Términos de Uso; no mezclar ambas ediciones. |
| IM v.360 (edición actual de Kendall Hunt) e Illustrative Mathematics tasks sueltos (`tasks.illustrativemathematics.org`) | CC BY-NC 4.0 / CC BY-NC-SA 4.0 + prohibición contractual de uso comercial en Términos de Uso | Solo inspiración — nunca reutilizar directamente en un producto comercial. |
